...
public interface CircleMembershipRepository extends JpaRepository<CircleMembership, UUID> {
    ...
    List<CircleMembership> findByCircleAndStatusOrderByJoinedAtAsc(Circle circle, MembershipStatus status);
    List<CircleMembership> findByUserAndStatus(User user, MembershipStatus status);
